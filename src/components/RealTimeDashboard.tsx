...
import { TrendingUp, TrendingDown, Volume2, AlertTriangle, Activity, Wifi, WifiOff, RefreshCw, Zap } from 'lucide-react';
...
export const RealTimeDashboard: React.FC = () => {
  ...
  const getConnectionStatusText = () => {
    switch (connectionStatus) {
      case 'connected': return 'Conectado à Binance';
      case 'connecting': return 'Conectando à Binance...';
    ...
    <div className="min-h-screen bg-gray-50 p-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-1">
              Real-time Binance Market Data • Live Trading Flow
            </p>
          </div>
          ...
          <div className="mt-4 p-4 bg-red-50 border border-red-200 rounded-lg">
            <div className="flex items-start">
              ...
              <div className="flex-1">
                <p className="font-medium text-red-800">Erro de Conexão com Binance</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        <div className="bg-white rounded-lg p-4 border border-gray-200">
          <div className="text-sm text-gray-600">Binance Status</div>
          <div className="text-2xl font-bold text-gray-900">
            {isConnected ? '🟢 LIVE' : '🔴 Offline'}
          </div>
          <div className="text-xs text-green-600 mt-1">Real Data</div>
        </div>
        <div className="bg-white rounded-lg p-4 border border-gray-200">
              ...
              <div className="text-center py-8">
                ...
                <div className="text-gray-500">
                  {connectionStatus === 'connecting' ? 
                    ...
                    'Conecte à Binance para ver dados reais'
                  }
                </div>
              </div>
            )}
      ...
      {chartData.length > 10 && (
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">Market Overview - Real Binance Data</h3>
